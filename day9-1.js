...
function solve(input) {
    ...
    characters.forEach(character => {
        if (!ignoreNext) {
            let isGarbage = true;
            if (debugLog) console.log("Acting on: " + character);
            if (character == "{" && !inGarbage) {                
                groupsSeen++;
                groupsDeep++;
                isGarbage = false;
            }
            ...
            if (isGarbage && inGarbage) garbageCount++;
        } else {
            ignoreNext = false;
            if (debugLog) console.log("Ignoring: " + character);            
        }
    });

    return  { groups: groupsSeen, score: score, garbageCount: garbageCount };
}